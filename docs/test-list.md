...
設計上更豐富，但「連續得分累積」本身會變成一個要測的行為，清單需重寫。
**尚未定案前不要開始第 1 項。**
...
- [ ] **5. 一方達 4 分以上且領先 2 分以上 → `Win for <player>`**
